...
console.log("result e, b", e, b);
e = [...a];
console.log("equal :", e.equal(a));
console.log("result e a", e, a);
e = [...a];
console.log("similar :", e.similar(b));
console.log("result e, b", e, b);
e = [...a];
console.log("similar e.reverseCopy(), b:", e.reverseCopy().similar(b));
console.log("result e.reverseCopy(), b", e.reverseCopy(), b);
e = [...a];
...
console.log("result", e);
e = [...a];
console.log("uniquesCopy :", e.uniquesCopy(2, 5));
console.log("result", e);
e = [...a];
...
console.log("result", e);
e = [...c];
console.log("flattenCopy :", e.flattenCopy(2, 7));
console.log("result", e);
e = [...c];
...
console.log("result", e);
e = [...a];
console.log("permutation start end:", e.permutator(2, 4, "inrange"));
console.log("result", e);
e = [...a];
console.log("Permutation Subsets start end replace:", e.permutationSubsets(2, 4, "replace"));
console.log("result", e);
e = [...a];
console.log("permutation start end:", e.permutator());
console.log("result", e);
e = [...a];
console.log("Permutation Subsets start end replace:", e.permutationSubsets());
console.log("result", e);
e = [...a];
